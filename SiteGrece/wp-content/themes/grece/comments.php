...
<strong><?php comment_author_link() ?></strong><?php comment_text() ?><?php _e(' -'); ?> <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('j F Y') ?> <?php _e('&agrave;');?> <?php comment_time() ?></a><?php edit_comment_link('Editer le commentaire'); ?>
